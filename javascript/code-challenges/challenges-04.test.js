...
const alphabetizeBetter = (arr) => {
  ...
  return arr.sort((a,b) =>{
    ...
    if(a.toLowerCase() > b.toLowerCase()){
      // console.log('first');
      // console.log(`a ${a} > b ${b}`);
      // console.log(`Comparison result, 1` );
      // console.log(`ascii code for a ${a.charCodeAt()} \n letter is ${String.fromCharCode(a.charCodeAt())}`);
      // console.log(`ascii code for b ${b.charCodeAt()} \n letter is ${String.fromCharCode(b.charCodeAt())}`);
      // console.log(` --- move b ${b} to before a ${a} ---`);
      return 1;
    }
    if(a.toLowerCase() < b.toLowerCase()){
      // console.log('second');
      ...
      // console.log(`ascii code for a ${a.charCodeAt()} \n letter is ${String.fromCharCode(a.charCodeAt())}`);
      // console.log(`ascii code for b ${b.charCodeAt()} \n letter is ${String.fromCharCode(b.charCodeAt())}`);
      // console.log(` --- move a ${a} to before b ${b} ---`);
      return -1;
    }
    if(a.toLowerCase() === b.toLowerCase()){
      // console.log('third');
      // console.log(`a ${a} == b ${b}`);
      // console.log(`Comparison result, 0 `);
      // console.log(`ascii code for a ${a.charCodeAt()} \n letter is ${String.fromCharCode(a.charCodeAt())}`);
      // console.log(`ascii code for b ${b.charCodeAt()} \n letter is ${String.fromCharCode(b.charCodeAt())}`);
