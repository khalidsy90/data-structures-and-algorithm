...
const addValues = (arr) => {
  // Solution code here...
  let sum=arr.reduce((accumlator,number) => {
...
const addPurchases = (arr) => {
  // Solution code here...
  let totalPurchases=arr.reduce((accumlator,number) =>{
    return accumlator + number.purchasePrice;
  },0);
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let count=arr.reduce((accumlator) => {
    return accumlator +1;
  },0);
  return count;
};
...
const returnNames = (arr) => {
  // Solution code here...
  let names=arr.reduce((accumlator,value) =>{
...
const reversedString = (str) => {
  // Solution code here...
  return str.split('').reduce((accumlator,char)=>{
    return char+accumlator;
  },'');
};
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  let childNames=arr.reduce((accumlator,item) => {
    // if(item.hasOwnProperty('children') ){
    //  return accumlator + item.children.length
    // }
    // return accumlator
...
const calculateAverage = (arr) => {
  // Solution code here...
  let temp=arr.reduce((accumlator,item) => {
    accumlator.count+=1;
    accumlator.sum+=item;
    return accumlator;
  },{ count: 0, sum: 0 });
  let result=temp.sum / temp.count;
  return result;
};
...
const countPrimeNumbers = (arr) => {
  // Solution code here...
  let count=arr.reduce((accumlator,num) =>{
    isPrime(num) ? accumlator.push(num) : '';
    return accumlator;
  },[]);
  return count.length;
};
...
const extractStat = (statName, arr) => {
  // Solution code here...
  let oneState=arr.reduce((accumlator,value) => {
  ...
  let names=arr.filter(item => {
    ...
    .reduce((accumlator,value) =>{
      ...
      if(value.hasOwnProperty('children')){
        accumlator.push(...value.children);
      }
      return accumlator;
    },[]);
  return names;
